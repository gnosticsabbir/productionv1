...
const Multicity = () => {
  ...
  useEffect(() => {
    setTotalTraveller(noOfAdt + noOfChildren + noOfKids);
  }, [noOfAdt, noOfChildren, noOfKids]);
  ...
  return (
    <div>
      ...
      <div className=''> 
            <div className='relative'>
            <input type="text" value={fromAirportName} onFocus={handleFromFocus} onChange={(e) => handleFromChange(e.target.value)} onBlur={handleFromBlur} className='w-full' />
            {isFromInputFocused && (
                <ul className='absolute w-full bg-white border border-gray-300'>
                    {fromList.length === 0 ? (
                        ...
                        fromList.map((item) => (
                            <li key={item.airportCode} onClick={() => handleFromSelect(item)} className='p-2 cursor-pointer hover:bg-gray-200'>
            ...
            <div className='relative'>
            <input type="text" value={toAirportName} onFocus={handleToFocus} onChange={(e) => handleToChange(e.target.value)} onBlur={handleToBlur} className='w-full' />
            {isToInputFocused && (
                <ul className='absolute w-full bg-white border border-gray-300'>
                    {toList.length === 0 ? (
                        <li className='p-2'>No options available</li>
                        ...
                        toList.map((item) => (
                            <li key={item.airportCode} onClick={() => handleToSelect(item)} className='p-2 cursor-pointer hover:bg-gray-200'>
                                {item.airportName} ({item.airportCode}) - {item.cityName}
                            </li>
                        ))
                    )}
        ...
        <div className=''>
            <div className=''>
                <div onClick={handleTravalervisible} className='border rounded px-2 py-1'>
                    {totalTraveller} Travelers <MdOutlineKeyboardArrowDown className="inline" />
                </div>
                {isVisibleTraveler && (
                    <div className='absolute w-full bg-white border border-gray-300'>
                        <div className='p-2'>
                            ...
                            <div className='flex'>
                                ...
                                <input type='number' value={noOfAdt} onChange={handleChangeAdult} min='0' />
                        ...
                        <div className='p-2'>
                            ...
                            <div className='flex'>
                                ...
                                <input type='number' value={noOfChildren} onChange={handleChangeChildren} min='0' />
                        ...
                        <div className='p-2'>
                            ...
                            <div className='flex'>
                                <button onClick={handleKidsDecrement}>-</button>
                                <input type='number' value={noOfKids} onChange={handleChangeKids} min='0' />
                                <button onClick={handleKidsIncrement}>+</button>
                            </div>
                        </div>
                    </div>
                )}
